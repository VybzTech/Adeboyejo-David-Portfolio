            ...
            <ScrollReveal key={process.id} direction="up" delay={i * 0.1}>
              <div
                ...
                className={cn(
                  ...
                  "p-6 rounded-2xl border border-2 transition-all duration-300 hover:shadow-lg relative overflow-hidden",
                  isDark
              ...
              >
                ...
                <div className="absolute -bottom-6 -right-6 opacity-10 group-hover:opacity-20 transition-opacity duration-300">
                  {IconComponent && (
                    <div className="w-24 h-24 text-primary [&_svg]:w-full [&_svg]:h-full [&_svg]:fill-current">
                      <IconComponent />
                    </div>
                  )}
                </div>
                ...
                <div className="relative z-10">
                  ...
                  <div className={cn(
                    ...
                    isDark ? "bg-primary/50" : "bg-primary/10",
                    "w-16 h-16 p-2.5"
                  )}>
                    {IconComponent && (
                      <div className={cn(
                        "w-full h-full flex items-center justify-center transition-all",
                        "[&_svg]:w-14 [&_svg]:h-14 [&_svg]:fill-current duration-300",
                        isDark ? "text-white/70 group-hover:text-white" : "text-primary/80 group-hover:text-primary"
                      )}>
                        <IconComponent />
                      </div>
                    )}
                  ...
                  <div className="flex items-start justify-between gap-2 mb-2">
                    ...
                    <ArrowUpRight
                      size={20}
                      className={cn(
                        "flex-shrink-0 mt-0.5 transition-transform group-hover:translate-x-1 group-hover:-translate-y-20 -translate-y-18",
