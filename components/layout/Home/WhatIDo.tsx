...
export function WhatIDo() {
  ...
  return (
    <CustomScrollbar>
      <section className={`relative min-h-screen py-24 overflow-hidden ${theme === 'dark' ? 'bg-[var(--background)]' : 'bg-[#fff]'}`}>
        {/* Animated Background Gradient */}
        <div className="absolute inset-0 opacity-40 pointer-events-none">
          <div className="fixed top-0 right-[-4%] w-64 h-64 bg-primary/40 rounded-full blur-2xl opacity-50 animate-pulse" />
          <div className="fixed bottom-0 left-[-4%] w-64 h-64 bg-secondary/40 rounded-full blur-2xl opacity-50 animate-pulse" style={{ animationDelay: "2s" }} />
        </div>
